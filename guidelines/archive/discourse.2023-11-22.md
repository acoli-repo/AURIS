...
> **Note**: So far, no intersentential examples of this discourse relation have been found.

- (20.1) **Although** the purchasing managers’ index continues to indicate a slowing economy, it isn’t signaling an imminent recession, said Robert Bretz, chairman of the association’s survey committee and director of materials management at Pitney Bowes Inc., Stamford, Conn. (PDTB2, 0036; INTRASENTENTIAL)

- (20.2) The documents also said that **although** the 64-year-old Mr. Cray has been working on the project for more than six years, the Cray-3 machine is at least another year away from a fully operational prototype. (PDTB3, wsj 0018; INTRASENTENTIAL)

- (20.3) It’s as if investors, the past few days, are betting that something is going to go wrong – **even if** they don’t know what. (PDTB3, wsj 0359; INTRASENTENTIAL)

- (20.4) **[Implicit=although]** Barely visible on Hong Kong’s property scene in 1985, by last year Japan had become the top foreign investor. (PDTB3, wsj 0524; INTRASENTENTIAL)
...
| &nbsp; - `after` | Asynchrony/After | |
| &nbsp; - `before` | Asynchrony/Before | |
| `EXPANSION`  | | EXPANSION |
| - `Manner` | Manner | |
| &nbsp; - `means` | Manner/Means | |
| &nbsp; - `achievement` | Manner/Achievement | |
| - `Exception` | Exception | |
| &nbsp; - `regular` | Exception/Regular | |
| &nbsp; - `exception` | Exception/Exception | |
| - `Similarity` | Similarity | |
| - `Substitution` | Substitution | |
| &nbsp; - `disfavoured` | Substitution/Disfavoured-alternative | |
| &nbsp; - `favoured` | Substitution/Favoured-alternative | |
| - `Conjunction` | Conjunction | |
| - `Disjunction` | Disjunction | |
| - `Excemplification` | Excemplification | |
| &nbsp; - `set` | Excemplification/Set | |
| &nbsp; - `instance` | Excemplification/Instance | |
| - `Elaboration` | Elaboration | | 
| &nbsp; - `broad` | Elaboration/Broad | |
| &nbsp; - `specific` | Elaboration/Specific | |
...
| **EntRel** | Expansion/Entity description | EntRel |

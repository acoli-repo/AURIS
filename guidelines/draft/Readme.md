...
The official first edition version of the coreference scheme was published as a technical report by Chiarcos and Krasavina (2005), and in a subsequent conference paper (Krasavina and Chiarcos 2007). The German instantiation of these guidelines was subsequently revised as part of the Handbuch Textannotation: Potsdamer Kommentarkorpus 2.0 (Stede et al., 2016).

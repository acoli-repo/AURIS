...
| Fig. 1. Template file                              |
| -------------------------------------------------- |
| [!Screenshot from template file](https://github.com/acoli-repo/acoli-is-corpus/blob/main/guidelines/draft/img/template.png?raw=true) |
...
| Fig. 2. Target file                            |
| ---------------------------------------------- |
| [!Screenshot from target file](https://github.com/acoli-repo/acoli-is-corpus/blob/main/guidelines/draft/img/target.png?raw=true) |
